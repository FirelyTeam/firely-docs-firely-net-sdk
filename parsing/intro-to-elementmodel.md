...
The next sections will detail how to use the `ISourceNode` based parsers in the SDK, how to add type information and serialize data back out using the `ITypedElement` based serializers.
