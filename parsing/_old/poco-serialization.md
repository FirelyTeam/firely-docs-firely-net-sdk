...
The FHIR specification introduces several [summary versions of resources](http://hl7.org/fhir/search.html#summary). You can serialize a POCO into one of these
...
```{caution}
This documentation describes features in a prelease of version 1.0 of the SDK. The documentation may be outdated and code examples may become incorrect.
```
