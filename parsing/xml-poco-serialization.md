...
The serializer can be told to serialize only parts of an object's tree, thus generating a [summary view](http://hl7.org/fhir/search.html#summary) of the FHIR data.
