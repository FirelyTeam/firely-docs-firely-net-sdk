...
The 2.0 transition docs can be [found here](https://github.com/FirelyTeam/firely-net-sdk/wiki/What's-new-and-changed-in-Firely-.NET-SDK-2.0%3F).

(sdk-releasenotes-1-3-0)=
...
the new parsing subsystem can be found in [the documentation](https://docs.fire.ly/projects/Firely-NET-SDK/parsing.html). Please note that
